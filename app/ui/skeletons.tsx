...
function CurrentlyItemSkeleton() {
  return (
    <div className='md:max-w-xs'>
      <div>
        <div
          className={`${shimmer} relative overflow-hidden bg-black/10 rounded-md mb-4 w-24 h-3`}
        />
      </div>
      <div className='flex flex-row align-top gap-3'>
        ...
        >
          <div className='bg-black/10 rounded-md w-16 h-16' />
        </div>
        <div className='ml-3 space-y-3 overflow-hidden'>
          <div
            className={`${shimmer} relative overflow-hidden bg-black/10 rounded-md w-36 h-3`}
          />
          <div
            className={`${shimmer} relative overflow-hidden bg-black/10 rounded-md w-24 h-3`}
          />
        </div>
      </div>
    </div>
...
export function ProfileImageSkeleton() {
  return <div className={`w-14 h-14 ${shimmer} bg-black/10 rounded-full`} />;
}
